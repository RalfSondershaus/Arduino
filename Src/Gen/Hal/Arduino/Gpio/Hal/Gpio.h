...
namespace hal
{
    static constexpr uint8_t kNrDigitalPins = NUM_DIGITAL_PINS; /**< Coding data support 6 bits only */
    ...
    struct GpioConfig
    {
        using pin_array_type = util::array<uint8_t, kNrDigitalPins>;
        /**
