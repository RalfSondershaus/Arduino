/**
 * @file Gen/Util/Intensity.h
 *
 * @brief Defines generic types for intensities
 *
...
#ifndef UTIL_INTENSITY_H_
#define UTIL_INTENSITY_H_
...
namespace util
{
    ...
    public:
        ...
        /// Sets intensity.
        This &operator=(const base_type i) noexcept
        {
            v = i;
            return *this;
        }
        This &operator=(const intensity8_255 &copy) noexcept
        {
            v = copy.v;
            return *this;
        }
    ...
    // -----------------------------------------------------------------------------
    /// 16 bit intensity: [0x0000 (0%) ... 0x8000 (100%)]
    // -----------------------------------------------------------------------------
    class intensity16
    {
    public:
    ...
    using speed16_ms = uint16;

    /// If used for intensity: maximal speed
    constexpr speed16_ms kSpeed16Max = 0x8000;
} // namespace util

#endif // UTIL_INTENSITY_H_
