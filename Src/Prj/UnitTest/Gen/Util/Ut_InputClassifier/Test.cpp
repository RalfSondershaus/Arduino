 ...
 *
 * @brief Test for Gen/Util/InputClassifier.h
 * 
...
#define V2P(v) util::classifier<kNrClasses>::convert_input(v)
    util::classifier_cal::cfg_limits_lo[0] = {V2P(0), V2P(104), V2P(204), V2P(304), V2P(404)};    // Lower limit for class x [0, 255]
    util::classifier_cal::cfg_limits_hi[0] = {V2P(100), V2P(200), V2P(300), V2P(400), V2P(1023)}; // Upper limit for class x [0, 255]
#undef V2P
    util::classifier_cal::pins[0] = 13;
    util::classifier_cal::debounces[0] = 10; // [10 ms] debounce
    ...
    {
        hal::stubs::analogRead[util::classifier_cal::pins[0]] = aSteps[nStep].nAdc;
...
TEST(Ut_InputClassifier, Test_3_Classifiers_5_Classes)
{
    ...
    classifier_array_type classifier;
    util::classifier_cal::pins = {13U, 14U, 15U};
    util::classifier_cal::debounces = {10U, 10U, 10U}; // [10 ms] debounce time
...
#define V2P(v) util::classifier<kNrClasses>::convert_input(v)
    util::classifier_cal::cfg_limits_lo[0] = {V2P(0), V2P(101), V2P(201), V2P(301), V2P(401)};   // Lower limit for class x [0, 255]
    util::classifier_cal::cfg_limits_hi[0] = {V2P(100), V2P(200), V2P(300), V2P(400), V2P(500)}; // Upper limit for class x [0, 255]
    util::classifier_cal::cfg_limits_lo[1] = {V2P(101), V2P(201), V2P(301), V2P(401), V2P(501)}; // Lower limit for class x [0, 255]
    util::classifier_cal::cfg_limits_hi[1] = {V2P(200), V2P(300), V2P(400), V2P(500), V2P(600)}; // Upper limit for class x [0, 255]
    util::classifier_cal::cfg_limits_lo[2] = {V2P(201), V2P(301), V2P(401), V2P(501), V2P(601)}; // Lower limit for class x [0, 255]
    util::classifier_cal::cfg_limits_hi[2] = {V2P(300), V2P(400), V2P(500), V2P(600), V2P(700)}; // Upper limit for class x [0, 255]
#undef V2P
...
#define V2P(v) classifier_type::convert_input(v)
    const classifier_cal_type cfg_limits1 =
        {
            debounce, {/* struct util::array */ {V2P(0), V2P(101), V2P(201), V2P(301), V2P(401)}} // Lower limit for class x [0, 255]
            ,
    ...
    const classifier_cal_type cfg_limits2 =
        {
            debounce, {{V2P(101), V2P(201), V2P(301), V2P(401), V2P(501)}} // Lower limit for class x [0, 255]
            ,
            {{V2P(200), V2P(300), V2P(400), V2P(500), V2P(600)}} // Upper limit for class x [0, 255]
        };
    const classifier_cal_type cfg_limits3 =
        {
            debounce, {{V2P(201), V2P(301), V2P(401), V2P(501), V2P(601)}} // Lower limit for class x [0, 255]
            ,
...
#undef V2P
    ...
    for (nStep = 0; nStep < sizeof(aSteps) / sizeof(step_type); nStep++)
    {
        for (int i = 0; i < 3; i++)
        {
            hal::stubs::analogRead[util::classifier_cal::pins[i]] = aSteps[nStep].anAdc[i];
            hal::stubs::millis = aSteps[nStep].ms;
            classifier.run();
