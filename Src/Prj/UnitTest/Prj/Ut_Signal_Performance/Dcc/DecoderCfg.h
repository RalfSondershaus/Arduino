/**
 * @file Prj/Ut_Signal_Performance/Dcc/DecoderCfg.h
 * 
 * @author Ralf Sondershaus
 * 
 * @brief DCC Decoder configuration definitions for Ut_Signal_Performance.
 *
...
#define CFG_DCC_DECODER_DEBUG          OPT_DCC_DECODER_DEBUG_ON
