...
TEST(Ut_Signal, InputClassifier1)
{
  ...
  tmp = cal::signal::make_signal_input(cal::signal::values::kInputType_ADC, kInputPin);
  ...
  tmp = cal::signal::make_signal_first_output(cal::signal::values::kOutputType_Onboard, kFirstOutputPin + 8);
  rte::ifc_cal_set_cv::call(cal::cv::eSignalFirstOutputBase + kSignalPos + 1, tmp);
  // ... with ADC input pin kInputPin+1
  tmp = cal::signal::make_signal_input(cal::signal::values::kInputType_ADC, kInputPin+1);
