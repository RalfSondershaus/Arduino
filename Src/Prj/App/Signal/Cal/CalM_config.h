...
#define EEPROM_INIT {                                                                                                                                         \
    ...
    cal::signal::kSignalNotUsed, cal::signal::kSignalNotUsed, cal::signal::kSignalNotUsed, cal::signal::kSignalNotUsed, /* CV 42 - 45 (signal IDs) */         \
    cal::signal::kSignalNotUsed, cal::signal::kSignalNotUsed, cal::signal::kSignalNotUsed, cal::signal::kSignalNotUsed, /* CV 46 - 49 (signal IDs) */         \
