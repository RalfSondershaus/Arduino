...
RTE_DEF_CYCLIC_RUNABLE(signal::InputClassifier, input_classifier, cycle10, 0, 1000)
RTE_DEF_CYCLIC_RUNABLE(signal::LedRouter, led_router, cycle10, 100, 1000)
...
RTE_DEF_INTERFACE_CS(Ifc_Cal_LedR, ifc_cal_codm_ledr, led_router, &led_router.set_cal)
RTE_DEF_INTERFACE_CS(Ifc_Cal_InputClassifier, ifc_cal_codm_inputclassifier, input_classifier, &input_classifier.set_cal)
RTE_DEF_INTERFACE_CS(Ifc_Rte_GetCommand, ifc_rte_get_cmd, input_command, &input_command.getCmd)
